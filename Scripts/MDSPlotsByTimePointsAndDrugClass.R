...
amrMatchT<-amrMatchT[, c(18,12)] #keep only the gene name and Drug Class columns
...
rgiMatchT<-rgiMatchT[, c(15,12)] #keep only the gene name and Drug Type columns
...
vsearchMatchT<-vsearchMatchT[, c(7,12)] #keep only the gene name and Drug Type columns
