...
#lm 2nd order
pdf("Plots/SortedByFSecondOrderMixedLm(BrackenLessThan600Days).pdf", width=12, height=18)
par(mfrow=c(3, 2))
par(mar=c(5, 6, 4, 1)+.1)
pvals<-vector()
Fpval<-vector()
...
pdf("Plots/SortedByFSecondOrderMixedLm(AMRLessThan600Days).pdf", width=12, height=18)
par(mfrow=c(3, 2))
par(mar=c(5, 6, 4, 1)+.1)
pvals<-vector()
Fpval<-vector()
...
pdf("Plots/SortedByFSecondOrderMixedLm(RGILessThan600Days).pdf", width=12, height=18)
par(mfrow=c(3, 2))
par(mar=c(5, 6, 4, 1)+.1)
pvals<-vector()
Fpval<-vector()
...
pdf("Plots/SortedByFSecondOrderMixedLm(vsearchLessThan600Days).pdf", width=12, height=18)
par(mfrow=c(3, 2))
par(mar=c(5, 6, 4, 1)+.1)
pvals<-vector()
Fpval<-vector()
