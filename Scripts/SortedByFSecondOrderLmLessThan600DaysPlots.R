...
#lm 2nd order
pdf("Plots/SortedByFSecondOrderLm(BrackenLessThan600Days).pdf", width=12, height=18)
par(mfrow=c(3, 2))
par(mar=c(5, 6, 4, 1)+.1)
...
pdf("Plots/SortedByFSecondOrderLm(AMRLessThan600Days).pdf", width=12, height=18)
par(mfrow=c(3, 2))
par(mar=c(5, 6, 4, 1)+.1)
...
pdf("Plots/SortedByFSecondOrderLm(RGILessThan600Days).pdf", width=12, height=18)
par(mfrow=c(3, 2))
par(mar=c(5, 6, 4, 1)+.1)
...
pdf("Plots/SortedByFSecondOrderLm(vsearchLessThan600Days).pdf", width=12, height=18)
par(mfrow=c(3, 2))
par(mar=c(5, 6, 4, 1)+.1)
